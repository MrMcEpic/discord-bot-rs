...
static DEEPSEEK_TOKEN: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"<\|.*?\|>").unwrap());
static LLAMA_INST: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\[/?INST\]").unwrap());
static LLAMA_SYS: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)<<?/?SYS>>?").unwrap());
