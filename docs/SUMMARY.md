...
- [First Bot Tutorial](getting-started/first-bot-tutorial.md)
- [Verifying Your Setup](getting-started/verifying-your-setup.md)
...
- [Games: Wordle](features/games-wordle.md)
- [Games: Connections](features/games-connections.md)
- [Games: Stocks](features/games-stocks.md)
- [Moderation](features/moderation.md)
- [Auto-Role Promotion](features/auto-role.md)
- [Member Join Features](features/join-features.md)
- [Minecraft: Verify](features/minecraft-verify.md)
- [Minecraft: Donator Sync](features/minecraft-donator-sync.md)
- [Minecraft: Chargeback Alerts](features/minecraft-chargeback.md)
...
- [Music Pipeline](architecture/music-pipeline.md)
...
- [PostgreSQL Setup](deployment/postgres-setup.md)
...
- [Adding a Feature Module](development/adding-a-feature-module.md)
...
- [MCP Tool Catalog](reference/mcp-tool-catalog.md)
